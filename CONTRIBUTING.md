Contributing to Cloudenode Core
============================

The Cloudenode Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Cloudenode Core project, and is not to be
confused with overall Cloudenode Network Protocol consensus changes.

Whether a pull request is merged into Cloudenode Core rests with the project merge
...
Patches that change Cloudenode consensus rules are considerably more involved than
...
Where a patch set proposes to change the Cloudenode consensus, it must have been
...
The project leader is the release manager for each Cloudenode Core release.
