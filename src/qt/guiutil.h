...
/** Utility functions used by the Cloudenode Qt UI.
 */
namespace GUIUtil
{
...
// Render Cloudenode addresses in monospace font
...
// Parse "cloudenode:" URI into recipient object, return true on successful parsing
