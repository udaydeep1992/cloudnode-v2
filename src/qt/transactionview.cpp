                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Rup from zCds"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zCds"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zCds));
