                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Cloudenode [CDS] v2") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Cloudenode address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cloudenode: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zCDS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Cloudenode Core"), this);
    aboutAction->setStatusTip(tr("Show information about Cloudenode Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Cloudenode"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Cloudenode addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Cloudenode addresses"));
    ...
    openAction->setStatusTip(tr("Open a Cloudenode: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Cloudenode Core help message to get a list with possible Cloudenode command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Cloudenode Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Cloudenode network", "", count));
}
...
{
    QString strTitle = tr("Cloudenode [CDS] v2"); // default title
