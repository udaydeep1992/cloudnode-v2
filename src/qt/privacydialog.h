...
public:
    ...
    void setZCdsControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzCDS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzCDS_clicked();
    void on_pushButtonZCdsControl_clicked();
