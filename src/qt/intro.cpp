...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Cloudenode [CDS] v2"),
     ...
     * override -datadir in the cloudenode.conf file in the default data directory
     * (to be consistent with cloudenoded behavior)
     */
    if (dataDir != getDefaultDataDirectory())
