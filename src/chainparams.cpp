...
public:
    CMainParams()
    {
       ...
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "CLOUDENODE - v2 arrived with new Developer Team.";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1559038713;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 455981;
		

	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000003907a77138a7b328171eeb609d0f6360487e0196042db713fafd7164a80"));
        assert(genesis.hashMerkleRoot == uint256("0x500f57dacf111eb1b7b80a7f726bf31f55ce82861dc118e3439849e5ba05069a"));
		
		vSeeds.push_back(CDNSSeedData("cds.blockchain-explorers.info", "cds.blockchain-explorers.info"));   // Primary DNS Seeder
		vSeeds.push_back(CDNSSeedData("45.77.131.227", "45.77.131.227"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Cloudenode: 1 day
        nTargetSpacing = 1 * 60;  // Cloudenode: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.cds.io", "testnet.cds.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.cds.io", "testnet1.cds.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.cloudenodecoin.org", "testnet.cloudenodecoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet cloudenode addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet cloudenode script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet cloudenode BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet cloudenode BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet cloudenode BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Cloudenode: 1 day
        nTargetSpacing = 1 * 60;        // Cloudenode: 1 minutes
