...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Cloudenode Core cloudenode-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  cloudenode-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded cloudenode transaction") + "\n" +
                               "  cloudenode-tx [options] -create [commands]   " + _("Create hex-encoded cloudenode transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded cloudenode transaction
