...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Cloudenode server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Cloudenode server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Cloudenode features */
        {"cloudenode", "masternode", &masternode, true, true, false},
        {"cloudenode", "listmasternodes", &listmasternodes, true, true, false},
        {"cloudenode", "getmasternodecount", &getmasternodecount, true, true, false},
        {"cloudenode", "masternodeconnect", &masternodeconnect, true, true, false},
        {"cloudenode", "masternodecurrent", &masternodecurrent, true, true, false},
        {"cloudenode", "masternodedebug", &masternodedebug, true, true, false},
        {"cloudenode", "startmasternode", &startmasternode, true, true, false},
        {"cloudenode", "createmasternodekey", &createmasternodekey, true, true, false},
        {"cloudenode", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"cloudenode", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"cloudenode", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"cloudenode", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"cloudenode", "getmasternodescores", &getmasternodescores, true, true, false},
        {"cloudenode", "mnbudget", &mnbudget, true, true, false},
        {"cloudenode", "preparebudget", &preparebudget, true, true, false},
        {"cloudenode", "submitbudget", &submitbudget, true, true, false},
        {"cloudenode", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"cloudenode", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"cloudenode", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"cloudenode", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"cloudenode", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"cloudenode", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"cloudenode", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"cloudenode", "checkbudgets", &checkbudgets, true, true, false},
        {"cloudenode", "mnsync", &mnsync, true, true, false},
        {"cloudenode", "spork", &spork, true, true, false},
        {"cloudenode", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"cloudenode", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use cloudenoded, or the -server option to cloudenode-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> cloudenode-cli " + methodname + " " + args + "\n";
}
