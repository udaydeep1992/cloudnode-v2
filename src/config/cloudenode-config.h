/* src/config/cloudenode-config.h.  Generated from cloudenode-config.h.in by configure.  */
/* src/config/cloudenode-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cloudenode.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cloudenode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cloudenode Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cloudenode"
