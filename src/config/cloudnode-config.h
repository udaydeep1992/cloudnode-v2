/* src/config/cloudnode-config.h.  Generated from cloudnode-config.h.in by configure.  */
/* src/config/cloudnode-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.cloudnode.in"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Cloudnode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Cloudnode Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "cloudnode"
