...
In order to support loading of multiple wallets in cloudenode-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is cloudenode.cpp.
...
Changes to cloudenode.cpp
----------------------
cloudenode.cpp is the entry point into cloudenode-qt, and as such, will require some minor modifications to provide hooks for
