...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/cloudenode-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/cloudenode-cli.cpp \
           src/cloudenode-tx.cpp \
           src/cloudenode.cpp \
           src/db.cpp \
           ...
           src/qt/cloudenode.cpp \
           src/qt/cloudenodestrings.cpp \
...
RESOURCES += src/qt/cloudenode.qrc src/qt/cloudenode_locale.qrc

TRANSLATIONS += src/qt/locale/cloudenode_bg.ts \
                src/qt/locale/cloudenode_de.ts \
                src/qt/locale/cloudenode_en.ts \
                src/qt/locale/cloudenode_es.ts \
                src/qt/locale/cloudenode_fi.ts \
                src/qt/locale/cloudenode_fr.ts \
                src/qt/locale/cloudenode_it.ts \
                src/qt/locale/cloudenode_ja.ts \
                src/qt/locale/cloudenode_pl.ts \
                src/qt/locale/cloudenode_pt.ts \
                src/qt/locale/cloudenode_ru.ts \
                src/qt/locale/cloudenode_sk.ts \
                src/qt/locale/cloudenode_sv.ts \
                src/qt/locale/cloudenode_vi.ts \
                src/qt/locale/cloudenode_zh_CN.ts \
                src/qt/locale/cloudenode_zh_TW.ts
